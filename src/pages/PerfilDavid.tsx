      ...
      <Grid container spacing={3}>
        <Grid item xs={12}>
          <Paper elevation={2} sx={{
            height: 300, 
            backgroundImage: 'url(https://images.unsplash.com/photo-1515704089429-fd06e6668458?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80)',
        ...
        <Paper elevation={2} sx={{
          ...
          <Typography variant='h3' color={'#fff'}>David Lustosa</Typography>
          <Typography variant='body1' mt={1} color={'#fff'}>22 anos | david@mail.com</Typography>
          <Divider sx={{marginTop: 2}} color={'#fff'}/>
          <Typography variant='body1' mt={1} color={'#fff'}>Aluno da 12ª edição do curso de Desenvolvimento Web Fullstack da Growdev</Typography>
          <Typography variant='body1' mt={1} color={'#fff'}>Stack: Fullstack</Typography>
          <Typography variant='body1' mt={1} color={'#fff'}>HardSkills: HTML, CSS, Javascript, Typescript, Bootstrap, React, Redux, NodeJs, Express</Typography>
          <Typography variant='body1' mt={1} color={'#fff'}>SoftSkills: Trabalha bem em equipe, Gosta de aprender, Focado na tarefa</Typography>
        </Paper>
